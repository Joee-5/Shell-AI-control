...
# Explicitly import message types
...
# The Z value is set to 0.5 to ensure visibility above the track model.
# ==============================================================================
TRACK_POINTS = [
...
class PathPublisher(Node):
    def __init__(self):
        ...
        # Publisher explicitly created for nav_msgs.msg.Path
        self.publisher_ = self.create_publisher(Path, TOPIC_NAME, 10)
        timer_period = 1.0 
        self.timer = self.create_timer(timer_period, self.timer_callback)
        self.get_logger().info(f"Publishing path data as nav_msgs/Path on {TOPIC_NAME}.")
    ...
    def timer_callback(self):
        ...
        # Set main message header (The type RViz checks first)
        ...
        for x, y, z in TRACK_POINTS:
            ...
            # Set PoseStamped header (RViz requires this for consistency)
